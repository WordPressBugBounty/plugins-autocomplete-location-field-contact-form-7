				...
				<table class="form-table" role="presentation">
				   <tbody>
				      ...
				      <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" placeholder="US,AU" name="gwaa_country_code" value="<?php echo esc_attr($gwaa_country_code); ?>" readonly /> <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			         ...
			         <tr valign="top">
			          ...
			          <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" placeholder="airport,art_gallery" name="gwaa_place_types" value="<?php echo esc_attr($gwaa_place_types); ?>"  readonly /><a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			         ...
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_enter_loc" value="<?php echo esc_attr(get_option('gwaa_tr_enter_loc','Enter a location')); ?>" readonly  />
			         ...
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_apartment" value="<?php echo esc_attr(get_option('gwaa_tr_apartment','Apartment, unit, suite, or floor #')); ?>" readonly  />
			               <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			            </td>
			         </tr>
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_city" value="<?php echo esc_attr(get_option('gwaa_tr_city','City')); ?>" readonly />
			               <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			            </td>
			         </tr>
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_state" value="<?php echo esc_attr(get_option('gwaa_tr_state','State/Province')); ?>" readonly />
			               <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			            </td>
			         </tr>
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_postalcode" value="<?php echo esc_attr(get_option('gwaa_tr_postalcode','Postal code')); ?>" readonly />
			               <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			            </td>
			         </tr>
			         <tr valign="top">
			            ...
			            <td>
			               <input class="regular-text" type="text" name="gwaa_tr_country" value="<?php echo esc_attr(get_option('gwaa_tr_country','Country/Region')); ?>" readonly />
			               <a href="https://www.codesmade.com/store/autocomplete-location-field-contact-form-7-pro/" target="_blank">Get Pro</a>
			            </td>
			         </tr>
				   </tbody>
...
<?php
	...
	public function GWAA_cf7_address_autocomplete_display_gpa_fields()
	{
			...
			register_setting('gwaa_section', 'gwaa_cf7_geo_api_key', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_country_code', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_address_option', array(
				'type' => 'array',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_place_types', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_enable_map', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));


			register_setting('gwaa_section', 'gwaa_tr_enter_loc', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_tr_apartment', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_tr_city', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_tr_state', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_tr_postalcode', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
			register_setting('gwaa_section', 'gwaa_tr_country', array(
				'type' => 'string',
				'sanitize_callback' => array($this,'GWAA_sanitize_setting'),
			));
